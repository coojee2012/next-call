<template>
  <div class="chat-box" @click="closeRefBox()" @mousemove="readedMessage()">
    <el-container>
            ...
            <el-footer height="240px" class="im-chat-footer">
              ...
              <div class="send-content-area">
                ...
                <div class="send-btn-area">
                  <el-button type="primary" size="small" @click="notifySend()"
                    >发送</el-button
                  >
                </div>
              </div>
      ...
      <emotion ref="emoBox" @emotion="onEmotion">
        <chat-record
          :visible="showRecord"
...
export default {
  ...
  methods: {
    ...
    showPrivateVideo(mode) {
      ...
      // 通过home.vue打开单人视频窗口
      $emit(this.$eventBus, 'openPrivateVideo', rtcInfo)
    },
    onGroupVideo() {
      this.$http({
    ...
    onInviteOk(members) {
      ...
      // 通过home.vue打开多人视频窗口
      $emit(this.$eventBus, 'openGroupVideo', rtcInfo)
    },
    showHistoryBox() {
  ...
  emits: ['openPrivateVideo', 'openGroupVideo'],
}
</script>
